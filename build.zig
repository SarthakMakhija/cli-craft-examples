...
pub fn build(b: *std.Build) void {
    ...
    // We create a module for our other entry point, 'main.zig'.
    ...
    exe_mod.addImport("cli_craft_examples_lib", lib_mod);
    exe_mod.addImport("cli_craft", clicraft_module);
    ...
    const lib = b.addLibrary(.{
        .linkage = .static,
        .name = "cli_craft_examples",
        .root_module = lib_mod,
    });

    // Add the prettytable module as an import
    lib_mod.addImport("cli_craft", clicraft_module);
